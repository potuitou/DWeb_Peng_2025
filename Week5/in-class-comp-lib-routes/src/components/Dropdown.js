...
const Dropdown = (props) => {
  ...
  //initialize a variable called divEl 
  const divEl = useRef()
  ...
  */
  ...
  //create and destroy the components
  useEffect(() => {},[])  //only runs ONE when the component first mounts = is visible on the screen
  useEffect(()=>{}) //run every time the component re-renders

  useEffect(()=> {}, [divEl])

  // //eg - api call - we never call api like this
  ...
  return (
    ...
    // we want to know if it exist and what is in it
